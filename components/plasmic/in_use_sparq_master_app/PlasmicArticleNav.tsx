...
import sty from "./PlasmicArticleNav.module.css"; // plasmic-import: PStYUYe__WmT/css
  ...
  return (
    (
      ...
      >
        ...
        >
          <div className={classNames(projectcss.all, sty.column__dd0S)}>
            <p.PlasmicImg
              ...
              src={{
                src: "/plasmic/in_use_sparq_master_app/images/logopng.png",
                fullWidth: 276,
                fullHeight: 46,
          ...
          <div className={classNames(projectcss.all, sty.column__yoQ5Z)}>
            <div
