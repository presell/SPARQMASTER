...
import Reviews from "../../Reviews"; // plasmic-import: o_WVJMCg7nB0/component
...
import sty from "./PlasmicArticleIntro.module.css"; // plasmic-import: Hmy657fkj6Oc/css
  ...
  return (
    ...
    >
      ...
      {(hasVariant(globalVariants, "screen", "desktopOnly") ? true : true) ? (
        ...
        >
          <div className={classNames(projectcss.all, sty.column__ya0Ma)}>
            <p.PlasmicImg
          ...
          <div className={classNames(projectcss.all, sty.column__rylLt)}>
            <div
              className={classNames(
                projectcss.all,
                projectcss.__wab_text,
