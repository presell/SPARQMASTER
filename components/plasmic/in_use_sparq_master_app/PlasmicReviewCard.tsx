...
import sty from "./PlasmicReviewCard.module.css"; // plasmic-import: 6yaIIveJrpL1/css
  ...
  return (
    true ? (
      ...
      >
        <p.PlasmicImg
          alt={""}
          className={classNames(sty.img__wyvep)}
          ...
          src={{
            src: "/plasmic/in_use_sparq_master_app/images/sidereview1Png.png",
            fullWidth: 119,
            fullHeight: 119,
        ...
        <p.PlasmicImg
          alt={""}
          className={classNames(sty.img__ruf6W)}
